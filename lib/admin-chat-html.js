...
<div class="admin-overlay" id="adminOverlay">
  ...
  <div class="admin-shell">
    ...
    <div id="adminSwitchPicker">
      ...
      <button class="admin-picker-option" id="pickerBackgrounds" onclick="adminPickDash('backgrounds')">
        <div class="admin-picker-icon" style="background:rgba(76,175,80,.12)">🖼</div>
        Page Backgrounds
      </button>
...
<!-- MAIN LAYOUT -->
    <div class="admin-layout" id="adminMainLayout" style="display:none;flex-direction:column;flex:1;overflow:hidden;min-height:0">
      ...
      <div class="admin-tab-bar" id="adminTabBar">
        ...
        <button class="admin-tab" id="tabBg" onclick="adminSetTab('backgrounds')">&#127756; Backgrounds</button>
      ...
      <!-- DASHBOARD CONTENT -->
      <div id="adminDashContent" style="display:none;flex:1;overflow:hidden;flex-direction:row">
        <!-- injected by JS based on mode -->
      </div>

      <!-- SOCIAL TAB CONTENT -->
      <div id="adminSocialContent" style="display:none;flex:1;overflow:hidden">
        <!-- injected by adminRenderSocialDash -->
      </div>

      <!-- BG TAB CONTENT -->
      <div id="adminBgContent" style="display:none;flex:1;overflow:hidden;flex-direction:column">
        <!-- injected by adminRenderBgDash -->
      </div>

      <!-- NAV TAB CONTENT -->
      <div id="adminNavContent" style="display:none;flex:1;overflow:hidden;flex-direction:column">
        <!-- injected by adminRenderNavDash -->
      </div>

      <!-- SUBMISSIONS TAB CONTENT -->
      <div id="adminSubContent" style="display:none;flex:1;overflow:hidden;flex-direction:column">
...
<div id="chatPanel">
  <div class="chat-header">
    ...
    <div>
      ...
      <div class="chat-header-sub">Usually replies instantly</div>
    </div>
