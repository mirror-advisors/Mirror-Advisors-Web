...
<div class="admin-overlay" id="adminOverlay">
  ...
  <div class="admin-shell">
    ...
    <div id="adminSwitchPicker">
      ...
      <button class="admin-picker-option" id="pickerAiSignups" onclick="adminPickDash('ai-signups')">
        <div class="admin-picker-icon" style="background:rgba(236,169,52,.12)">🤖</div>
        AI Signups
      </button>
    </div>
...
<!-- MAIN LAYOUT -->
    <div class="admin-layout" id="adminMainLayout" style="display:none;flex-direction:column;flex:1;overflow:hidden;min-height:0">
      ...
      <div class="admin-tab-bar" id="adminTabBar">
        ...
        <button class="admin-tab" id="tabAiSignups" onclick="adminSetTab('ai-signups')">🤖 AI Signups</button>
      ...
      <!-- AI SIGNUPS TAB CONTENT -->
      <div id="adminAiSignupsContent" style="display:none;flex:1;overflow:hidden;flex-direction:column;min-height:0">
        <!-- injected by adminRenderAiSignupsDash -->
      </div>
...
<!-- #adminTrigger button moved into the footer (on top of the copyright ©
     glyph) — see lib/footer.js. The previous fixed bottom-right position
     was covered by the SalesIQ chat bubble. -->

<div id="adminToast" class="admin-toast"></div>

<button id="chatBtn" aria-label="Chat with us">
  <div class="chat-pulse"></div>
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0D1232" stroke-width="2.5">
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
    <line x1="12" y1="9" x2="12" y2="9.01" stroke-width="3"/>
    <line x1="8" y1="9" x2="8" y2="9.01" stroke-width="3"/>
    <line x1="16" y1="9" x2="16" y2="9.01" stroke-width="3"/>
  </svg>
</button>
...
<div id="chatPanel">
  <div class="chat-header">
    ...
    <div>
      <div class="chat-header-title">Mirror Advisors</div>
      <div class="chat-header-sub">Ask anything &mdash; AI assistant</div>
    </div>
    <button class="chat-header-close" onclick="chatToggle()">&#10005;</button>
  </div>
  <div class="chat-messages" id="chatMessages"></div>

  <!-- Free-text input — submits a question to the Supabase Edge Function
       at /functions/v1/chat which proxies to Gemini. Wired up by
       _initChatInput() in site-runtime.js. -->
  <form id="chatInputForm" class="chat-input-row" autocomplete="off">
    <input
      id="chatInput"
      class="chat-input"
      type="text"
      placeholder="Ask a question about Mirror Advisors..."
      aria-label="Ask the Mirror Advisors assistant"
      maxlength="500"
    >
    <button id="chatSendBtn" class="chat-send-btn" type="submit" aria-label="Send message">
  ...
  <div class="chat-footer">Powered by Mirror Advisors &bull; <a onclick="go('contact')" style="color:var(--t);cursor:pointer">Book a call</a></div>
</div>`;
