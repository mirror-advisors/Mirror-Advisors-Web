...
function _buildCaseDetailHTML(c, opts){
  ...
  html += '<div class="cd-aside">'
    ...
    + '<p>Every Mirror Advisors engagement starts with a Mirror Scope, a paid discovery that maps your systems and builds your implementation plan.</p>'
    + (preview
...
var _CHAT_GREETING = "Hi. I'm the Mirror Advisors assistant. Ask me anything about our services, how we work, or how we engage with new clients.";
...
function _chatStart() {
  ...
  var greeting = firstName
    ? ('Welcome back, ' + firstName + '. What would you like to explore today?')
    : _CHAT_GREETING;
...
// Removed 2026-09 rebuild: legacy svcs widget (five-engagement-model tab strip)
// belonged to the pre-restructure homepage/services page. The new services
// overview + six dedicated service pages render six static <a> cards from
// data/pages.js and need no runtime widget.
...
_INIT.services=function(){
  // The 2026-09 rebuild replaced the runtime-rendered services widget (four
  // engagement models + FAQ accordion) with a static six-card overview in
  // data/pages.js. No init work needed. Keeping the function present so the
  // route dispatch _INIT.<key> lookup does not warn.
};
