...
if (typeof window !== 'undefined') {
  ...
  function _pocRenderWebsite(name, details, logoDataUrl) {
    ...
    return [
      ...
      '<div style="background:#fffefc;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;flex:1;min-height:100%">',
      ...
      '    <span>Product</span><span>About</span><span>Pricing</span>',
      '  </div>',
      '  <div style="padding:8px 16px;background:#0f3e17;color:#fffefc;border-radius:14px;font-family:'+SANS+';font-size:12px;font-weight:400">Book a Demo &rarr;</div>',
      '</div>',
      ...
      '      <div style="padding:12px 20px;background:#0f3e17;color:#fffefc;border-radius:14px;font-family:'+SANS+';font-size:13px;font-weight:400">Get started &rarr;</div>',
      '      <div style="padding:12px 18px;background:#fffefc;color:#0f3e17;border-radius:14px;font-family:'+SANS+';font-size:13px;font-weight:400">Learn more</div>',
      '    </div>',
      '  </div>',
  ...
  function _pocRenderCrm(name, details, logoDataUrl) {
    ...
    return [
      ...
      '      <div style="padding:9px 12px;border-radius:7px;background:#e1f4df;font-family:'+SANS+';font-size:12px;font-weight:600;color:#0f3e17">Dashboard</div>',
      '      <div style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Customers</div>',
      '      <div style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Analytics</div>',
      '      <div style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Documents</div>',
      '      <div style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Settings</div>',
      '    </div>',
