...
if (typeof window !== 'undefined') {
  ...
  function _pocRenderWebsite(name, details, logoDataUrl) {
    ...
    return [
      '<div style="background:#0E1422;border:1px solid rgba(255,255,255,.08);border-radius:12px;overflow:hidden;display:flex;flex-direction:column;flex:1;min-height:100%">',
      // Browser chrome
      '<div style="display:flex;align-items:center;gap:6px;padding:10px 14px;background:#080B16;border-bottom:1px solid rgba(255,255,255,.06);flex-shrink:0">',
      ...
      '</div>',
      // Hero
      '<div style="padding:32px 24px 24px;position:relative;overflow:hidden;flex:1;display:flex;flex-direction:column;justify-content:space-between">',
  ...
  function _pocRenderCrm(name, details, logoDataUrl) {
    ...
    return [
      ...
      '<div style="display:grid;grid-template-columns:96px 1fr;flex:1;min-height:0">',
      // Sidebar
