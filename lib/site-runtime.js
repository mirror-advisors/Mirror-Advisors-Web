...
if (typeof window !== 'undefined') {
  ...
  // Website mockup — Ease Health / botanical-greenhouse aesthetic.
  // Warm cream base, forest-ink typography, sage/keylime/mint/slate
  // tinted panels, weight-300 Cormorant Garamond serif headlines,
  // no shadows anywhere. Depth comes from layered tinted fills.
  function _pocRenderWebsite(name, details, logoDataUrl) {
    ...
    // Shared font stacks (Cormorant Garamond substitutes for Faire Octave; Inter for Suisse Intl)
    ...
    return [
      // Outermost wrapper — cream page canvas
      '<div style="background:#fffefc;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;flex:1;min-height:100%;position:relative">',

      // Browser chrome — subtle light gray so it matches the cream page beneath
      ...
      // Nav row — cream background, forest-ink text, forest CTA pill
      ...
      '  </div>',
      '  <div style="display:flex;gap:22px;font-family:'+SANS+';font-size:13px;font-weight:400;color:#222">',
      '    <span class="poc-interactive" onclick="pocGoContact()">Product</span><span class="poc-interactive" onclick="pocGoContact()">About</span><span class="poc-interactive" onclick="pocGoContact()">Pricing</span>',
      '  </div>',
      ...
      // Hero: 2-column, keylime (left) + slate (right)
      '<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;padding:22px;flex:1;background:#fffefc">',

      // Left panel — Keylime Wash with serif headline + body + forest CTA
      ...
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:12px 18px;background:#fffefc;color:#0f3e17;border-radius:14px;font-family:'+SANS+';font-size:13px;font-weight:400">Learn more</div>',
      '    </div>',
      '  </div>',

      // Right panel — Slate Hush with 3 cream product-preview cards
      '  <div style="background:#b6ced5;border-radius:14px;padding:20px;display:flex;flex-direction:column;gap:10px">',
      '    <div class="poc-interactive" onclick="pocGoContact()" style="background:#fffefc;border-radius:12px;padding:16px 18px">',
      ...
      // Bottom "investor logos" strip — monochrome on cream, editorial rhythm
      '<div style="display:flex;justify-content:space-around;align-items:center;padding:20px 28px;background:#fffefc;border-top:1px solid #efeeeb;flex-shrink:0">',
      ...
      // Floating "Book a Call" chat bubble — mimics a real live-chat
      // widget in the corner of the mockup. Clicking routes to /contact.
  ...
  // CRM mockup — Ease Health / botanical-greenhouse aesthetic.
  // Cream background sidebar + main pane, forest-ink text, tinted
  // stat cards (keylime / mint / sage), Slate Hush activity panel
  // with cream product-preview rows inside. No shadows.
  function _pocRenderCrm(name, details, logoDataUrl) {
    ...
    return [
      ...
      // Browser chrome — light gray to match the cream body
      '<div style="display:flex;align-items:center;gap:6px;padding:10px 14px;background:#efeeeb;border-bottom:1px solid #e5e3df;flex-shrink:0">',
      '  <span style="width:9px;height:9px;border-radius:50%;background:#ff5f57"></span>',
      '  <span style="width:9px;height:9px;border-radius:50%;background:#ffbd2e"></span>',
      '  <span style="width:9px;height:9px;border-radius:50%;background:#28c840"></span>',
      ...
      // Sidebar — cream + forest ink, active item highlighted with keylime
      '  <div style="background:#fffefc;padding:20px 14px;display:flex;flex-direction:column;border-right:1px solid #efeeeb">',
      '    <div style="display:flex;align-items:center;gap:10px;padding-bottom:18px;border-bottom:1px solid #efeeeb;margin-bottom:16px">',
      logoBlock,
      ...
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:9px 12px;border-radius:7px;background:#e1f4df;font-family:'+SANS+';font-size:12px;font-weight:600;color:#0f3e17">Dashboard</div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Customers</div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Analytics</div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Documents</div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="padding:9px 12px;border-radius:7px;font-family:'+SANS+';font-size:12px;font-weight:400;color:#222">Settings</div>',
      '    </div>',
      ...
      // Main content — cream with forest ink typography
      '  <div style="background:#fffefc;padding:28px 32px;overflow:hidden;display:flex;flex-direction:column;gap:20px">',
      '    <div>',
      ...
      // 3 stat cards — keylime, mint, sage
      '    <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:14px">',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="background:#e1f4df;border-radius:14px;padding:22px">',
      ...
      '      </div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="background:#cfe7d3;border-radius:14px;padding:22px">',
      ...
      '      </div>',
      '      <div class="poc-interactive" onclick="pocGoContact()" style="background:#b1dbb8;border-radius:14px;padding:22px">',
      ...
      // Slate Hush activity panel with cream cards inside
      ...
      '        <span style="font-family:'+SANS+';font-size:10px;font-weight:600;letter-spacing:.09em;text-transform:uppercase;color:#0f3e17">VIEW ALL</span>',
      '      </div>',
      '      <div style="display:flex;flex-direction:column;gap:10px;flex:1">',
      '        <div class="poc-interactive" onclick="pocGoContact()" style="background:#fffefc;border-radius:12px;padding:14px 16px;display:flex;align-items:center;gap:12px">',
      ...
      // Floating "Book a Call" chat bubble — mirrors the one on the
      // Website mockup so both PoC types share the same funnel.
      '<div class="poc-chat-bubble" onclick="pocGoContact()"><span class="poc-chat-bubble-dot"></span>Book a Call with Mirror Advisors &rarr;</div>',
