...
window.addEventListener('scroll', () => {
  ...
  (function(){
    ...
    var LOGOS = {
      ...
      zoho_expense: '/images/zoho-expense.svg',
...
window.adminDeleteCase = function(){
  ...
  window._CASES.splice(_adminIdx,1); adminCancelEdit(); window.renderCases('All'); _refreshHomeScroll(); _adminToast('Case study deleted.');
};
