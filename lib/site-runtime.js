...
var _SERVICES_SUBLINKS = [
  ...
  { route: 'services/zoho-implementation',   key: 'zoho-implementation',   label: 'Zoho Implementation' },
  { route: 'services/custom-ai-application', key: 'custom-ai-application', label: 'Custom AI Application' },
];
    ...
    nl.innerHTML = pages.filter(function(p){ return p.enabled && !p.parent; }).map(function(p){
      ...
      if (p.key === 'services') {
        var subs = _SERVICES_SUBLINKS.filter(function(s){
          ...
          return '<a href="#" onclick="go(\'' + s.route + '\'); return false;" class="nav-drop-link">' + label + '</a>';
        }).join('');
...
window.navResetDefaults = function(){
  window._NAV_PAGES = [
    ...
    { key:'zoho-implementation',     label:'Zoho Implementation',     enabled:true, parent:'services' },
    { key:'custom-ai-application',   label:'Custom AI Application',   enabled:true, parent:'services' },
    { key:'cases',                   label:'Case Studies',            enabled:true },
    { key:'technology',              label:'Technology',              enabled:true },
    { key:'about',                   label:'About',                   enabled:true },
    { key:'artificial-intelligence', label:'AI',                      enabled:true },
    { key:'contact',                 label:'Contact',                 enabled:true },
    { key:'ai-field-guide',          label:'AI Field Guide',          enabled:true },
  ];
