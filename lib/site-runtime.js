...
if (typeof window !== 'undefined') {
  ...
  function _pocRenderWebsite(name, details, logoDataUrl) {
    ...
    return [
      ...
      '      </div>',
      '      <div style="background:#fffefc;border-radius:12px;padding:16px 18px">',
      '        <span style="display:inline-block;font-family:'+SANS+';font-size:10px;font-weight:600;letter-spacing:.09em;text-transform:uppercase;color:#0f3e17;margin-bottom:6px">Zero Lock-in</span>',
      '        <div style="font-family:'+SERIF+';font-size:20px;font-weight:300;color:#0f3e17;line-height:1.1;letter-spacing:-.01em;margin-bottom:4px">Full source handover.</div>',
      '        <div style="font-family:'+SANS+';font-size:11.5px;color:#222;line-height:1.5">Own the code, host it anywhere.</div>',
      '      </div>',
      '      <div style="background:#fffefc;border-radius:12px;padding:16px 18px">',
