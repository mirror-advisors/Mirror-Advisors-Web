...
var _SERVICES_SUBLINKS = [
  ...
  { route: 'services/digital-marketing',     key: 'digital-marketing',     label: 'Digital Marketing' },
...
window.navResetDefaults = function(){
  window._NAV_PAGES = [
    ...
    { key:'digital-marketing',     label:'Digital Marketing',     enabled:true, parent:'services' },
...
var _SUB_SERVICES = ['Zoho implementation','Custom apps','Claude AI solutions','Digital marketing'];
