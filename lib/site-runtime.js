...
var AI_SIGNUP_STEPS = [
  ...
  { key:'phone',       type:'tel',         prompt:function(a){ var n=(a.name||'').split(/\s+/)[0]; return (n?"Nice to meet you, "+n+". ":"")+"What's the best number to reach you on?"; }, placeholder:"(555) 123-4567" },
